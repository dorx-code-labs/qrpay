...
import 'package:qrpay/core_views.dart/about_us_view.dart';
import 'package:qrpay/services/cards.dart';
import 'package:qrpay/services/navigation.dart';
import 'package:qrpay/views/main_screen.dart';

import 'constants/basic.dart';
import 'constants/ui.dart';
import 'core_views.dart/splash_screen.dart';
import 'models/usable_constants.dart';
            ...
            return MultiProvider(
              ...
              child: MaterialApp(
                ...
                theme: ThemeData(
                  ...
                  chipTheme: _brightness == Brightness.light
                      ? null
                      : ChipThemeData(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<dynamic> _services = [
    ...
    ['Scan', Iconsax.camera, Colors.green],
  ];
          ...
          child: ListTileTheme(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  onTap: () {
                    NavigationService().push(context, ContactPage());
                  },
